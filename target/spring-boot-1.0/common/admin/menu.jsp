...
<%--</ul>--%>
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="16" fill="currentColor" class="bi bi-buildings-fill" viewBox="0 0 16 16">
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle" style="display: flex; align-items: center" >
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="20" fill="currentColor" class="bi bi-person-vcard-fill" viewBox="0 0 16 16" >
